      ...
      <main className="pt-32 pb-24">
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              {[
                ...
                <div key={index} className="glass rounded-glass p-6">
                  <div className="text-emerald mb-4">{impact.icon}</div>
                  <h3 className="text-xl font-semibold text-brand-text mb-2">{impact.title}</h3>
                  <p className="text-brand-text-sec">{impact.description}</p>
                </div>
              ))}
            </div>
            ...
            <p className="text-brand-text-sec mb-4">
              Every day without AI is a day of wasted productivity. AI is now automating tasks like:
            </p>
            <ul className="space-y-2 mb-8">
              <li className="text-brand-text-sec">• 24/7 customer support through smart agents</li>
              <li className="text-brand-text-sec">• Real-time reporting and forecasting</li>
              <li className="text-brand-text-sec">• Marketing content generation and optimization</li>
            </ul>
            <p className="text-brand-text-sec mb-8">
            ...
            <ul className="space-y-2 mb-8">
              <li className="text-brand-text-sec">• Retailers use AI to predict demand and personalize offers</li>
              <li className="text-brand-text-sec">• Financial firms deploy AI for fraud detection and dynamic pricing</li>
              <li className="text-brand-text-sec">• Healthcare providers rely on AI for diagnostics and workflow automation</li>
            </ul>
            <p className="text-brand-text-sec mb-8">
            ...
            <ul className="space-y-2 mb-8">
              <li className="text-brand-text-sec">• Personalized recommendations</li>
              <li className="text-brand-text-sec">• Instant, intelligent support</li>
              <li className="text-brand-text-sec">• Predictive, proactive service</li>
            </ul>
            <p className="text-brand-text-sec mb-8">
            ...
            <ul className="space-y-2 mb-8">
              <li className="text-brand-text-sec">• Real-time cybersecurity threat detection</li>
              <li className="text-brand-text-sec">• Automated compliance monitoring</li>
              <li className="text-brand-text-sec">• Fraud and anomaly detection</li>
            </ul>
            <p className="text-brand-text-sec mb-8">
            ...
            <ul className="space-y-2 mb-8">
              <li className="text-brand-text-sec">• How customers perceive your relevance</li>
              <li className="text-brand-text-sec">• Whether investors see you as future-proof</li>
              <li className="text-brand-text-sec">• How talent assesses your leadership</li>
            </ul>
            <p className="text-brand-text-sec mb-8">
            ...
            <div className="glass rounded-glass p-8 mb-12">
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3 text-brand-text-sec">
            ...
            <p className="text-base text-brand-text-sec mb-8 font-semibold">
