        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <ul className="space-y-2 mb-8">
              <li className="text-brand-text-sec">• How fast teams learn and apply new knowledge</li>
              <li className="text-brand-text-sec">• How decisions are made (and improved over time)</li>
              <li className="text-brand-text-sec">• How well insights are shared across departments</li>
              <li className="text-brand-text-sec">• How open people are to challenge, feedback, and change</li>
            </ul>
            <p className="text-brand-text-sec mb-8">
            ...
            <div className="glass rounded-glass p-8 mb-12">
              <h3 className="text-xl font-semibold text-brand-text mb-4">Action:</h3>
            ...
            <ul className="space-y-2 mb-8">
              <li className="text-brand-text-sec">• "What are we missing?"</li>
              <li className="text-brand-text-sec">• "Why has it always been done this way?"</li>
              <li className="text-brand-text-sec">• "What does the data actually say?"</li>
              <li className="text-brand-text-sec">• "Is there a smarter, simpler way?"</li>
            </ul>
            ...
            <ul className="space-y-2 mb-8">
              <li className="text-brand-text-sec">• Capturing lessons from every project</li>
              <li className="text-brand-text-sec">• Running debriefs not just on failures, but successes</li>
              <li className="text-brand-text-sec">• Encouraging peer-to-peer learning</li>
              <li className="text-brand-text-sec">• Giving space for reflection, not just production</li>
            </ul>
